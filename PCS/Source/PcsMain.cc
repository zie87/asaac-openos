...
ASAAC_ReturnStatus handleListenAttachedChannels(ASAAC_PCS_MessageParameter &Parameter)
{
#ifdef _DEBUG_
	cout << "PCS: handleListenAttachedChannels() will start VcListenThread " << endl;
#endif
	//SBS: !!! The VcListenerThread shall be started later after full configuration of all VC/TC attachments !!!
	Parameter._u.reply_listen.result = ASAAC_APOS_startThread(2); //SBS: this shall be VcListenThread
