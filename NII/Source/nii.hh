...
class cMosNii
{
  public:
    ...
    NiiReturnStatus sendTransfer( PublicId tc_id, 
    ...
    NiiReturnStatus receiveTransfer(PublicId tc_id, 
                                    char* receive_data,
    ...
    NiiReturnStatus receiveNetwork(const NetworkDescriptor& network_id, char* receive_data, Length data_length_available, Length& data_length, PublicId& tc_id, Time time_out);
