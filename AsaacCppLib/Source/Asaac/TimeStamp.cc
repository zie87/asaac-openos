...
{
	ldiv_t d = ldiv(nano_seconds, (long)1000000000);
...
TimeStamp TimeStamp::Now(TimeType type)
{
	...
	switch (type)
	{
		case AbsoluteLocal:  ASAAC_MOS_getAbsoluteLocalTime(&t); break;
		case AbsoluteGlobal: ASAAC_MOS_getAbsoluteGlobalTime(&t); break;
		case RelativeLocal:  ASAAC_MOS_getRelativeLocalTime(&t); break;
		default: break;
	}
