...
public:
	 ...
	 *   started when it is set into RUNNING state, via Process::run().
	 * 
	...
	//! predict the amount of memory for control and data structures to be allocated via an internal allocator
