...
ASAAC_Exception::ASAAC_Exception( const char* Message, const char* Function, int Line )
{
	initialize();
...
const char * ASAAC_Exception::getMessage()
{
...
const char * ASAAC_Exception::getMessageItem(unsigned short index)
{
	if (index >= m_PathSize)
		return EmptyString;
...
void ASAAC_Exception::printMessage()
{
	cerr << getMessage() << endl;
}


void ASAAC_Exception::logMessage()
{
...
void ASAAC_Exception::addPath(  const char* Message, const char* Function, int Line )
{
