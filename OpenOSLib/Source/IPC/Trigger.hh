...
public:
	...
	ASAAC_TimedReturnStatus waitForTrigger( unsigned int& TriggerState, const ASAAC_TimeInterval& Timeout = TimeIntervalInfinity );
    /*!< transfer the calling thread into WAITING state until the counter of the trigger exceeds the value
    ...
    /*!< transfer the calling thread into WAITING state until the counter of the trigger is increased over
