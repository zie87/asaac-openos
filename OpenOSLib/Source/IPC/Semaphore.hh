 ...
 *   within the implementation of the OS core, providing intra- and interprocess locking mechanisms
...
public:
    ...
    /*!< transfer the calling thread into WAITING state until the counter of the semaphore is positive, or
