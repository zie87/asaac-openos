...
public:
	...
	Mutex( Allocator* ThisAllocator, bool IsMaster = true, int Procotol = 0 /* = PTHREAD_PRIO_INHERIT */ );
	
	//! non-initializing constructor
	Mutex( );

	//! explicit initialization
	void initialize( Allocator* ThisAllocator, bool IsMaster = true, int Protocol = 0 /* = PTHREAD_PRIO_INHERIT */ );
