...
//! Class to protect a scope of execution from interruption and/or concurrent execution
 ...
 *  has to be declared at the beginning of the scope (or whatever else point to start the
...
{
public:
	//! instantiate the scope protection and set it into effect
