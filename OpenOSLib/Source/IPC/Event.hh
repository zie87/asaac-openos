 ...
 * Section 11.4.4), but extends the functionality to allow for longer-process synchronization as required for
 ...
 * 
 */
static const unsigned long INITIALIZED_FLAG = 54749010;
...
public:
	...
	unsigned long getWaitingThreads();
