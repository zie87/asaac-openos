 ...
 *  interfaces as specified in STANAG 4626, Part II, Section 11.4.5.
 * 
...
public:
	 ...
	 *   GSM and the application, into the error queue that conveys messages to the GSM.
	 * 
	 ...
	 * 
	 *   \returns ASAAC_SUCCESS if the error could successfully be placed into the error queue,
	 ...
	 * 
	 *   \returns ASAAC_SUCCESS if the message could be properly placed into the log message queue.
	 * 			  ASAAC_ERROR otherwise.
	 */
