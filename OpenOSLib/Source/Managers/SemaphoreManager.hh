...
protected:
	...
	int findSemaphoreByName( const ASAAC_CharacterSequence& SemaphoreName );
	int findSemaphoreByPrivateId( const ASAAC_PrivateId SemaphoreId );
	...
	unsigned int	m_NumberOfSemaphores;
