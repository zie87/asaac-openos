...
public:
        ...
        ASAAC_ReturnStatus openFile( const ASAAC_CharacterSequence& Name, FileType Type, int Flags, int& FileHandle );
        ...
        ASAAC_ReturnStatus closeFile( const ASAAC_CharacterSequence& Name, int Flags = -1 );
                
        //! close a filesystem object indicated by file handle
        ASAAC_ReturnStatus closeFile( int FileHandle );
        ...
        ASAAC_ReturnStatus removeFile( int FileHandle );
                

		//! get the file handle of
        int getFileHandle( const ASAAC_CharacterSequence& Name, FileType Type, int Flags, long Size = 0);
        ...
        ASAAC_ReturnStatus saveState( int& SavedStateHandle );
        ...
        ASAAC_ReturnStatus restoreStateByHandle( int SavedStateHandle );
...
protected:
        ...
        FileInfoBlock*  findFileByName( const ASAAC_CharacterSequence& Name, int Flags = -1);
        FileInfoBlock*  findFileByHandle( int Handle );
