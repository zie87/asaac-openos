...
public:
    ...
    virtual ASAAC_Address allocate(int Size) = 0; 
     ...
     * 
     * Note: This is an optional method. While a provided interface, classes realizing the 
     * allocator interface need not take any action on a 'free' call.
     */
    
    virtual void reset() = 0;
    //!< reset all internal structures of the allocator
    /*!< All internal data structures contained in the allocator will be reset,
    ...
    virtual unsigned int getFreeMemory() const = 0;
    //!< get number of free bytes available in the allocator
    
    virtual unsigned int getUsedMemory() const = 0;
