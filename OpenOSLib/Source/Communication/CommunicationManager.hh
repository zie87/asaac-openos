...
//! singleton class providing methods to create and configure communication interfaces
...
public:
	...
	//! SMOS call to configure a network interface. 
	...
	//! SMOS call to interface with NII
