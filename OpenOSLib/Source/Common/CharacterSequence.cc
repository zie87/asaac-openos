...
#include "Common/TimeInterval.hh"
...
CharacterSequence::CharacterSequence(int number)
{
	char buffer[16];
...
CharacterSequence::CharacterSequence(unsigned int number)
{
	char buffer[16];
...
CharacterSequence & CharacterSequence::append( int number )
{
	this->append(CharacterSequence(number));
	return *this;
}

CharacterSequence & CharacterSequence::append( unsigned int number )
{
	this->append(CharacterSequence(number));
	return *this;
}
...
CharacterSequence & CharacterSequence::assign( int number )
{
	this->assign(CharacterSequence(number));
	return *this;
}

CharacterSequence & CharacterSequence::assign( unsigned int number )
{
	this->assign(CharacterSequence(number));
	return *this;
}
...
CharacterSequence & CharacterSequence::insert( unsigned long pos, int number )
{
	this->insert(pos, CharacterSequence(number));
	return *this;
}

CharacterSequence & CharacterSequence::insert( unsigned long pos, unsigned int number )
{
	this->insert(pos, CharacterSequence(number));
	return *this;
}
...
int CharacterSequence::compare(const CharacterSequence &data) const
{
	return m_Data.compare(data.m_Data);
}

int CharacterSequence::compare(const char *data) const
{
	if (checkCharString(data))
...
int CharacterSequence::compare(const string &data) const
{
	return m_Data.compare(data);
}

int CharacterSequence::compare(const ASAAC_CharacterSequence data) const
{
...
void CharacterSequence::convertTo( int &number, unsigned long begin_pos, unsigned long len ) const
{
...
void CharacterSequence::convertTo( unsigned int &number, unsigned long begin_pos, unsigned long len ) const
{
	CharacterSequence Data;
	this->convertTo(Data, begin_pos, len);
...
CharacterSequence & CharacterSequence::operator=(int number)
{
	this->assign(number);
	return *this;
}

CharacterSequence & CharacterSequence::operator=(unsigned int number)
{
	this->assign(number);
	return *this;
}
