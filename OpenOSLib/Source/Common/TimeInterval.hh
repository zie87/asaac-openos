...
const ASAAC_TimeInterval TimeIntervalInstant = TimeInterval::Instant().asaac_Interval();
const ASAAC_TimeInterval TimeIntervalInfinity = TimeInterval::Infinity().asaac_Interval();
